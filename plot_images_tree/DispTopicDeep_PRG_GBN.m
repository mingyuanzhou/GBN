%% Rerproduce Figures 22-23
for K0=[25,50,100,200,400,600]
    load(['ZGlobalMnist_CJ_K0_',num2str(K0),'_T_5_eta050_PreTrain0_AllForPhi0_TrimStrategy5_Trial1_Data'])
