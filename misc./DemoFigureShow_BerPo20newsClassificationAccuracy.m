%close all;
path='/Users/zhoum/Box Sync/GBN_results/results/'
T   =   5  ;
% 
 path = '/Users/zhoum/Box Sync/GBN_results/results1/'
 path = '/Users/zhoum/Box Sync/GBN_results/results1_modifyK600K800/'
  path = '/Users/zhoum/Box Sync/GBN_results/results_PRG_GBN_results2/'
 %path = '/Users/zhoum/Box Sync/GBN_results/results1_modifyK600K800/tfidf/'
 T   =   5  ;

 for K0=[50,100,200,400,600,800]
     load([path,'ZGlobalTrim_BerPo_20newsBydate_K0_',num2str(K0),'_T_5_eta050_PreTrain0_AllForPhi0_TrimStrategy5_Trial1_Data'])
     ParaGlobal{5}.Phi
 end
ToBeAnalized    =   9   ;
...
K0_all = [50,100,200,400]%,600]%,800,1000]
...
if i1==5
    ...
    K0_all =  [16,32,64,128,256,512]%,1024]; %,1024];%,1024];
    K0Set111  =  K0_all(2:end);
elseif i1==0
    dataname    =   '20newsBydate';
    K0_all =  [5,10,25,50,100,200,400,600,800]%,600,800];
    K0Set111  = [50,100,200,400,600,800]%,800] %,800]
     K0Set111  = [50,100,200,400,600,800]%,800] %,800]
end
...
for trialii111     =   1:length(TrialSet111)
    ...
    for kii111     =   1:length(K0Set111)
        ...
        %nameccc     =   ['Main_PretrainTrim_',dataname,'_K0_',num2str(K0111),'_T_',num2str(T),'_SuPara',num2str(super1or2),...
        %        '_AllForPhi',num2str(Settings.AllForPhi),'_TrimStrategy',num2str(Settings.TrimStrategy),'_Trial',num2str(trial),'_Data.mat']     ;
        nameccc     =   [path,'Trim_BerPo_',dataname,'_K0_',num2str(K0111),'_T_',num2str(T),'_eta0',num2str(round(eta0*1000)),...
